...
void setup() {
  ...
  String payloadConfig = "{\"name\": \"SmartPlug\", \"command_topic\": \"nodemcu/smartplug/control\", \"state_topic\": \"nodemcu/smartplug/state\"}";
  mqttClient.publish("homeassistant/switch/nodemcu/smartplug/config", payloadConfig.c_str(), true);
