...
const char* topicControl = "homeassistant/esp32/sensorsolo/control";
const char* topicState   = "homeassistant/esp32/sensorsolo/state";
...
void setup() {
  ...
  String payloadConfig = "{\"name\": \"sensorsolo\", \"command_topic\": \"homeassistant/esp32/sensorsolo/control\", \"state_topic\": \"homeassistant/esp32/modesensorsololo/state\"}";
  mqttClient.publish("homeassistant/esp32/sensorsolo/config", payloadConfig.c_str(), true);
