...
const PROGMEM char* MQTT_CLIENT_ID = "homeassistant";
const PROGMEM char* MQTT_SERVER_IP = "192.168.15.10";
const PROGMEM uint16_t MQTT_SERVER_PORT = 1883;
const PROGMEM char* MQTT_USER = "renatobritomqtt";
...
//  StaticJsonBuffer<200> jsonBuffer;
  ...
  doc["temperature"] = 8; //(String)p_temperature;
  doc["humidity"] = 7; //(String)p_humidity;
  ...
  */
  ...
  //serializeJson(data, doc.measureLength() + 1);
...
void loop() {
  ...
  float h = h + 1; // dht.readHumidity();
  // Read temperature as Celsius (the default)
  float t = t + 2;  // dht.readTemperature();
