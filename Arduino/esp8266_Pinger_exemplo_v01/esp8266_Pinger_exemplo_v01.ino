...
void loop() {
  ...
  if(destination != ""){
  inputString = source + destination;
  src = "";
  des = "";
  source = "";
  destination = "";
...
/* (q,l)=window, e=current eval. srcore, */
/* E=e.p. sqr.z=prev.dest, n=depth; return srcore */
      ...
      if (u & k) {                                /*  own piece (inefficient!)*/
        ...
        { A:                                        /* resume normal after best */
          ...
          do {                                      /* y traverses ray, or:     */
            ...
            v = d - 1 ? e : i - p;                   /* MVV/LVA srcoring          */
            if (d - !t > 1)                          /* remaining depth          */
            { v = p < 6 ? b[x + 8] - b[y + 8] : 0;    /* center positional pts.   */
              b[G] = b[H] = b[x] = 0; b[y] = u | 32;  /* do move, set non-virgin  */
              if (!(G & M))b[F] = k + 6, v += 50;     /* castling: put R & srcore  */
              ...
              { v -= 9 * ((x - 2 & M || b[x - 2] - u) + /* structure, undefended    */
                ...
                b[y] += V; i += V;                     /* change piece, add srcore  */
              }
